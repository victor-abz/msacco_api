...
from msacco_api.query_builder.builder import MariaDB, Postgres
from msacco_api.query_builder.functions import Function

if typing.TYPE_CHECKING:
	from msacco_api.query_builder import DocType
...
class LazyMogrify(LazyString):
	...
	def _setup(self) -> str:
		return frappe.cbs_db.mogrify(self.query, self.values)
