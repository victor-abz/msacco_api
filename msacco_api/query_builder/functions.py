...
from msacco_api.query_builder.custom import (GROUP_CONCAT, MATCH, STRING_AGG,
                                             TO_TSVECTOR)
from msacco_api.query_builder.utils import ImportMapper, db_type_is
...
class Cast_(Function):
    def __init__(self, value, as_type, alias=None):
        if frappe.cbs_db.db_type == "mariadb" and (
...
def _aggregate(function, dt, fieldname, filters, **kwargs):
    return (
        frappe.cbs_qb.engine.build_conditions(dt, filters)
